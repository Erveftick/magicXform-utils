...
EXP_NAME=$(python -m spacer.exp_name /home/ekvashyn/Code/mXf/experiments/exp-template/idx/benchmarks_combo.idx)
...
time $PARALLEL -j $JOBS --ungroup --results $OUT/{/} $TOOL :::: /home/ekvashyn/Code/mXf/experiments/exp-template/idx/benchmarks_combo.idx
