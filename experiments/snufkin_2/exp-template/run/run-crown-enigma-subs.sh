...
EXP_NAME=$(python -m spacer.exp_name /home/ekvashyn/Code/mXf/experiments/snufkin_2/exp-template/idx/benchmarks_subs.idx)
...
time $PARALLEL -j $JOBS --ungroup --results $OUT/{/} $TOOL :::: /home/ekvashyn/Code/mXf/experiments/snufkin_2/exp-template/idx/benchmarks_subs.idx
