...
EXP_NAME=$(python -m spacer.exp_name /private/tmp/exp/idx/benchmarks_combo.idx)
...
time $PARALLEL -j $JOBS --ungroup --results $OUT/{/} $TOOL :::: /private/tmp/exp/idx/benchmarks_combo.idx
