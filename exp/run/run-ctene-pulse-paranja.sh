...
TOOL_NAME=ctene
OPTS_NAME=pulse
VERSION_NAME=paranja
TOOL=/private/tmp/exp/run/ctene-pulse.sh

EXP_NAME=$(python -m spacer.exp_name /private/tmp/exp/idx/benchmarks_paranja.idx)
...
time $PARALLEL -j $JOBS --ungroup --results $OUT/{/} $TOOL :::: /private/tmp/exp/idx/benchmarks_paranja.idx
